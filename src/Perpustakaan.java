...
public class Perpustakaan {
    ...
    public Perpustakaan() {
        ...
        daftarAnggota.add(new Anggota("001", "Hendro", "Salatiga"));//insert instance to array
        daftarAnggota.add(new Anggota("002", "Hendro", "Semarang"));
    ...
    public Buku searchBuku(String kode) {
        ...
        for (int x = 0; x < daftarBuku.size(); x++) {
            buku = (Buku)daftarBuku.get(x); // unknown usage
